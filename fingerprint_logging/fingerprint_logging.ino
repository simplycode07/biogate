...
void loop() {
  if (digitalRead(buttonPin)) {
    ...
    if (finger != -1) {
      ...
      // printTimeToSerial();
      // Serial.print(" : ");
      // Serial.print(finger_id_string);
      // Serial.println(" logged in"); // prints logs to serial
  ...
  if (!digitalRead(settingsPin) && settings_mode) {  // this means settings mode was previously 1 but then value of settings pin was set to low
